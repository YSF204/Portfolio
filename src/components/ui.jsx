...
export function ThemeToggle({ theme, toggleTheme }) {
  return (
    <button
      onClick={toggleTheme}
      className="absolute top-4 right-4 w-9 h-9 rounded-full border border-dashed border-[#8B0000]/70 dark:border-[#600000] bg-white dark:bg-[#0d0d0f] flex items-center justify-center text-zinc-400 dark:text-[#777] hover:text-zinc-900 dark:hover:text-white hover:border-[#8B0000] dark:hover:border-[#8B0000] hover:scale-110 transition-all duration-200 z-20"
